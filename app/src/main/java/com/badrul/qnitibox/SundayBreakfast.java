...
public class SundayBreakfast extends AppCompatActivity {

	ImageButton continueBtn;
	ImageButton eventBtn;
	String menuType = "Breakfast";
	String menuDay = "Sunday";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		continueBtn.setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
				...
				SharedPreferences sharedPreferences = SundayBreakfast.this.getSharedPreferences(Config.SHARED_PREF_NAME,
				...
				Intent i = new Intent(SundayBreakfast.this, OrderMenu.class);
		...
		eventBtn.setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
				...
				Intent i = new Intent(SundayBreakfast.this, StaffOrder.class);
				i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
				startActivity(i);
				finish();
			}
