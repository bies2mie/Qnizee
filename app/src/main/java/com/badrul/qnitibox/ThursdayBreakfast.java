...
public class ThursdayBreakfast extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		continueBtn.setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
				...
				SharedPreferences sharedPreferences = ThursdayBreakfast.this
				...
				Intent i = new Intent(ThursdayBreakfast.this, OrderMenu.class);
		...
		eventBtn.setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
				...
				Intent i = new Intent(ThursdayBreakfast.this, StaffOrder.class);
				i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
				startActivity(i);
				finish();
			}
