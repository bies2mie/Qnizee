...
public class TuesdayBreakfast extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		continueBtn.setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
				...
				SharedPreferences sharedPreferences = TuesdayBreakfast.this
				...
				Intent i = new Intent(TuesdayBreakfast.this, IndvOrder.class);
		...
		eventBtn.setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
				...
				Intent i = new Intent(TuesdayBreakfast.this, StaffOrder.class);
				i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
				startActivity(i);
				finish();
			}
