...
public class TuesdayDinner extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		continueBtn.setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
				...
				SharedPreferences sharedPreferences = TuesdayDinner.this.getSharedPreferences(Config.SHARED_PREF_NAME,
				...
				Intent i = new Intent(TuesdayDinner.this, IndvOrder.class);
		...
		eventBtn.setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
				...
				Intent i = new Intent(TuesdayDinner.this, StaffOrder.class);
				i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
				startActivity(i);
				finish();
			}
