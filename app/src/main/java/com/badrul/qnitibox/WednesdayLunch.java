...
public class WednesdayLunch extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		continueBtn.setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
				...
				SharedPreferences sharedPreferences = WednesdayLunch.this.getSharedPreferences(Config.SHARED_PREF_NAME,
				...
				Intent i = new Intent(WednesdayLunch.this, OrderMenu.class);
		...
		eventBtn.setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
				...
				Intent i = new Intent(WednesdayLunch.this, StaffOrder.class);
				i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
				startActivity(i);
				finish();
			}
